                ...
                <section className="hero">
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-sm-12">
                            <h1 className="main--title">MOTION WE <br/>
                                IT СТУДИЯ</h1>
                        ...
                        <div className="col-lg-6 col-sm-12 box-2">
                ...
                <div className="woow aniAman">
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-12">
                            <h3 className="woow-title aniAmani">На все курсы на <br/> этой неделе 30%</h3>
                        </div>
                        <div className="col-lg-6 col-md-12">
                            <div className="woow-block aniAmani">
                                <div className="row">
                                    <div className="col-lg-6 col-md-12">
                                    ...
                                    <div className="col-lg-12 col-md-12">
                                        <Clock className="demo" endTime={100} />
